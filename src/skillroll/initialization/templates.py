...
def render_starter_case(name: str) -> bytes:
    ...
    return (
        ...
        "```\n\n"
        "## Input\n\n"
        "Write a realistic request. Include only what the agent would already know."
        "\n\n"
        "## World\n\n"
        "Describe the outside world for the Dungeon Master to simulate: people, "
        "systems, files, and likely action results.\n\n"
        "## Success criteria\n\n"
